...
function ReviewDetails() {
    ...
    const loanDetails = useSelector( state => state.loan.currentLoan);
    ...
    return <div>
        ...
        <h2>Basic Details</h2> <Link to="/apply" name="basicDetailsEdit">Edit</Link>
        <table border={1}>
        ...
        <h2>Contact Details</h2> <Link to="/contact" name="contactDetailsEdit">Edit</Link>
        <table border={1}>
